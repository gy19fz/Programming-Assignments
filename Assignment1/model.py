...
num_of_redfish = int(input('Please input the number (an integer) of predators and then press enter.\n(Integers from 5 to 10 are recommended): '))
# The number of prey-bluefish 
num_of_bluefish = int(input('Please input the number (an integer) of prey and then press enter.\n(Integers from 20 to 30 are recommended): '))  
...
# the Internet environment and other factors. Here I took a simpler approach to
# initialise agents.
agents = []
redfish = []
